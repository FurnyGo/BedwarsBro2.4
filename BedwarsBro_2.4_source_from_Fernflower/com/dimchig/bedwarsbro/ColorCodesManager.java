...
public class ColorCodesManager {
   ...
   public static String removeColorCodes(String text) {
      String str = text;
      String[] colorcodes = new String[]{"4", "c", "6", "e", "2", "a", "b", "3", "1", "9", "d", "5", "f", "F", "7", "8", "0", "k", "m", "o", "l", "n", "r"};
      String[] var3 = colorcodes;
      int var4 = colorcodes.length;
